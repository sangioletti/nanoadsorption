...
from units import *
from system_variables_dosing import *
...
for factor in factors:
    ...
    for i, sigma_R in enumerate(sigma_R_values):
        bound_fraction, K_bind_vs_receptors = system_ref.calculate_bound_fraction_with_fluctuations_correct(
                                K_bind_0,
                                sigma_R,
                                K_bind_vs_receptors,
        ...
        nads_out[i] = float(bound_fraction) * NP_conc_i * V_SPR
