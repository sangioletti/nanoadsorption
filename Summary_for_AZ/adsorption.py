...
class MultivalentBinding:
    ...
    def K_LR(self, h, N, a, K_bind_0):
        ...
        if self.polymer_model in [ "gaussian", "ideal", "Flory" ]:
    ...
    def calculate_binding_constant(self, K_bind_0, sigma_L, sigma_R,
        ...
        if self.binding_model == "saddle":
            ...
            try:
                #Needed to avoid numerical errors that only arise for very large K_bind
            ...
            A_L = N * a**2  # Approximate area spanned by ligand
