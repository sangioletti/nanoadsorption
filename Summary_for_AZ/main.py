...
# Create the system
# binding_model can be saddle or exact (numerical integration)
...
with open( 'adsorption.dat', 'w+' ) as f:
    ...
    for sigma_R in np.logspace( min_exp, max_exp, n_sampling_points ):
        ...
        adsorbed_fraction = system_saddle.calculate_bound_fraction( K_bind=K_bind )
        ...
        print( f'Adsorbed fraction: {out3:5.3e}' )
        print( "------------------" )
